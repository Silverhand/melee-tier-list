...
var char2 = ['', 'Fox', '', 'Fox', 'Fox', 'Sheik', '', '', '', '', '', '', '', '', 'Fox', 'Ganondorf', '', '', '', '', '', '', '', 'Sheik', '', 'Fox', '', '', 'Marth', 'Marth', 'Sheik', '', '', '', '', 'Falco', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'Fox', '', '', 'Captain Falcon', '', '', '', '', '', '', 'Marth', '', '', '', '', '', 'Marth', '', 'Sheik', '', '', '', '', '', '', '', '', 'Falco', '', '', '', 'Falco', 'Sheik', '', 'Fox', '', '', '', '', '', '', 'Fox', '', '', '', 'Fox', 'Marth'];
var char3 = ['', '', '', 'Samus', '', 'Fox', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'Marth', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''];
var weightChars = ["Fox", "Sheik", "Falco", "Marth", "Ice Climbers", "Jigglypuff", "Captain Falcon", "Peach", "Samus", "Yoshi", "Pikachu", "Ganondorf"];
var weightResults = [];
...
for(var i = 0; i < rank.length; i++) {
    ...
    if(char3[i] == '' && char2[i] == '' && char1[i] != '') {
        ...
        weight = 0.5 * formula(rank[i]);
        addToResults(weight, char1[i]);

        weight = 0.5 * formula(rank[i]);
        addToResults(weight, char2[i]);
    } else if (char3[i] != '' && char2[i] != '' && char1[i] != '') {
        weight = 0.33 * formula(rank[i]);
        addToResults(weight, char1[i]);
